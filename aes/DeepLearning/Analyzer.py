...
def calculate_kappa(y_true, y_pred):
    ...
    qwk_value = Metrics.quadratic_weighted_kappa(decoded_y_true, decoded_y_pred, 0, 12)
    lwk_value = Metrics.linear_weighted_kappa(decoded_y_true, decoded_y_pred, 0, 12)
